    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_agree_with_agreement', models.DateTimeField(blank=True, null=True, verbose_name='is agree with user agreement')),
                ('is_phone_proved', models.BooleanField(default=False, verbose_name='is phone proved')),
                ('is_email_proved', models.BooleanField(default=False, verbose_name='is email proved')),
            ...
            managers=[
                ('objects', apps.helpers.managers.UserDeletedManager()),
            ],
        ),
        migrations.AddIndex(
            model_name='user',
